...
var grpc_reflection_v1_reflection_pb = require('../../../grpc/reflection/v1/reflection_pb.js');

function serialize_grpc_reflection_v1_ServerReflectionRequest(arg) {
  if (!(arg instanceof grpc_reflection_v1_reflection_pb.ServerReflectionRequest)) {
...
function deserialize_grpc_reflection_v1_ServerReflectionRequest(buffer_arg) {
  return grpc_reflection_v1_reflection_pb.ServerReflectionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_grpc_reflection_v1_ServerReflectionResponse(arg) {
  if (!(arg instanceof grpc_reflection_v1_reflection_pb.ServerReflectionResponse)) {
...
function deserialize_grpc_reflection_v1_ServerReflectionResponse(buffer_arg) {
  return grpc_reflection_v1_reflection_pb.ServerReflectionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
serverReflectionInfo: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: grpc_reflection_v1_reflection_pb.ServerReflectionRequest,
    responseType: grpc_reflection_v1_reflection_pb.ServerReflectionResponse,
